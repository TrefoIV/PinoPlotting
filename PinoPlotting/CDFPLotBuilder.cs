...
namespace MyPlotting
{
    public class CDFPLotBuilder : AbstractPlot
    {
        ...
        public void AddCDFToPlot(IEnumerable<double> inputData, string label = null, int steps = CDFUtils.DEFAULT_STEPS, Color? color = null)
        {
            ...
            if (LogY)
            {
                ...
                inputData = ys.Select(y => _xGenerator.Log(y)).ToList();
