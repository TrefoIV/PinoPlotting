...
namespace MyPlotting
{
	public class DoubleSidedLinePlotBuilder : LinePlotBuilder
	{
		...
		public void AddRightSidePlot(double[] data, string label = "", Color? color = null, float size = 5f, LinePattern? linePattern = null, MarkerShape marker = MarkerShape.FilledCircle)
		{
